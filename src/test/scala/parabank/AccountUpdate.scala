...
class AccountUpdate extends Simulation {
  ...
  private val scn = scenario("AccountUpdate")
    .exec(
      http("request_0")
      ...
      http("request_23")
        ...
        .resources(
          ...
          http("request_41")
            .get("/parabank/images/footerbg.gif")
            .headers(headers_2),
          http("CUSTOMER_INFO_REQUEST")
            .get("/parabank/services_proxy/bank/customers/12212")
            .headers(headers_21),
          http("request_43")
            .get("/parabank/images/bullet2-hover.gif")
            .headers(headers_2)
    ...
    .exec(
      http("UPDATE_RECORDS")
        .post("/parabank/services_proxy/bank/customers/update/12212?firstName=John&lastName=SmithAUTOMATION&street=1431%20Main%20St%20123&city=Beverly%20Hills123&state=CA&zipCode=90210&phoneNumber=310-447-4121&ssn=622-11-9999&username=john&password=demo")
        .headers(headers_44)
    )
